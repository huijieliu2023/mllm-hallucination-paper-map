...
**网站当前条目：** 467 篇去重论文；其中 382 篇已链接到指定会议/期刊的官方 proceedings 或出版页面，85 篇保留为 Preprint / venue to verify。核心幻觉论文与相邻忠实性研究在网页中分别标记。
**年份范围：** 2023—2026。2026 条目只有在正式 proceedings 页面可核验时才标注目标会议。

**本轮全量目录扫描：** 2026 年 9 月 14 日按会议与年份重新扫描 ACL、ICML、ICLR、NeurIPS、CVPR、ICCV、ECCV、EMNLP 与 NAACL 的官方目录，并补充 AAAI 官方 OJS、IJCV 出版页面和 WWW 官方/DOI 记录。ICML 2023—2025 使用 PMLR 正式卷，2026 使用 ICML 官方日程；ACL 系列使用 ACL Anthology 的主会与 Findings 页面。新增条目在网页中区分“核心幻觉”与“相关研究”；题名未明确研究幻觉、但与视觉证据、感知/推理忠实性或不确定性直接相关的论文不会混入核心幻觉计数。
