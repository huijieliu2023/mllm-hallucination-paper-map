...
**核心条目：** 334 篇去重候选论文；其中 236 篇已链接到指定会议/期刊的官方 proceedings 或出版页面，98 篇保留为 Preprint / venue to verify。
**年份范围：** 2023—2026。2026 条目只有在正式 proceedings 页面可核验时才标注目标会议。

**本轮全量目录扫描：** 2026 年 9 月 14 日重新扫描 ICML、ICLR、NeurIPS、CVPR、ICCV、ECCV、EMNLP 与 NAACL 的官方目录，并补充 AAAI 官方 OJS、IJCV 出版页面和 WWW 官方/DOI 记录。新增条目在网页中区分“核心幻觉”与“相关研究”；题名未明确研究幻觉、但与视觉证据、感知/推理忠实性或不确定性直接相关的论文不会混入核心幻觉计数。
